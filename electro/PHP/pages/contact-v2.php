										...
										<div class="form-group row">
											<div class="col-xs-12 col-md-6">
												...
												<span class="wpcf7-form-control-wrap first-name">
													<input type="text" name="first-name" value="" size="40" class="wpcf7-form-control input-text" aria-required="true" aria-invalid="false" />
												</span>
											</div>
										...
										<div class="inner-left-xs">
											<div class="wpb_wrapper">
												...
												<p>Monday to Friday: 9am-9pm<br />
													...
													<h3>Careers</h3>
												<p>If you&#8217;re interested in employment opportunities at Electro, please email us: <a href="mailto:contact@yourstore.com">contact@yourstore.com</a>
												</p>
