                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="product-thumbnail">
                                            ...
                                            <img width="180" height="180" alt="1" class="wp-post-image" src="assets/images/products/2.jpg"></a>
                                        </td>

                                        <td class="product-name">
                                            <a href="index.php?page=single-product">White Solo 2 Wireless</a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="product-thumbnail">
                                            <a href="index.php?page=single-product">
                                            <img width="180" height="180" alt="Ultrabooks" class="wp-post-image" src="assets/images/products/3.jpg"></a>
                                        </td>

                                        <td class="product-name">
                                            <a href="index.php?page=single-product">Tablet Red EliteBook  Revolve 810 G2</a>
                                        </td>
                                    ...
                                    <tr >
                                        ...
                                        <td class="product-thumbnail">
                                            <a href="index.php?page=single-product"><img width="180" height="180" alt="GameStation" class=" wp-post-image" src="assets/images/products/1.jpg"></a>
                                        </td>

                                        <td class="product-name">
                                            <a href="index.php?page=single-product">GameConsole Destiny  Special Edition</a>
                                        </td>
