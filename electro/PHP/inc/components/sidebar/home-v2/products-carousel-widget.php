        ...
        <div id="products-carousel-57176fb2dc4a8">
            <div class="products owl-carousel  products-carousel-widget columns-1">
                ...
                <div class="product-carousel-alt">
                    ...
                    <span class="loop-product-categories"><a href="index.php?page=single-product" rel="tag">Smartwatches</a></span><a href="index.php?page=single-product"><h3>Smartwatch 2.0 LTE Wifi  Waterproof</h3></a>
                ...
                <div class="product-carousel-alt">
                    ...
                    <span class="loop-product-categories"><a href="index.php?page=single-product" rel="tag">Audio Speakers</a></span><a href="index.php?page=single-product"><h3>Wireless Audio System Multiroom 360</h3></a>
                ...
                <div class="product-carousel-alt">
                    ...
                    <span class="loop-product-categories"><a href="index.php?page=single-product" rel="tag">Laptops</a></span><a href="index.php?page=single-product"><h3>Notebook Widescreen Y700-17 GF790</h3></a>
                ...
                <div class="product-carousel-alt">
                    ...
                    </a><span class="loop-product-categories"><a href="index.php?page=single-product" rel="tag">Game Consoles</a></span><a href="index.php?page=single-product"><h3>Game Console Controller <br />+ USB 3.0 Cable</h3></a>
