...
">
    ...
    <?php 
            ...
            <form action="" method= "get"> 
                ...
                <input type="hidden" name = "del_producto" value="<?php echo $Codigodel =  $Lista['Codigo'];?>">    
            ...
            <tr>
                ...
                <td><button class = "btn btn-outline-danger" type="submit" formaction="php/ABCProducto.php?del_producto=<?php $Codigodel;?>&eliminar = 3">Eliminar</button></td>
            </tr>
               </form>
