        ...
        <div class="row">
            <div class="col-sm-6 col-lg-3 mb-2-6">
                <div class="card-wrapper mb-4">
                    <div class="card-img"><img src="img/AirPodsPro2.png" alt="Producto 1"></div>
                    <div class="card-body">
                        <div>
                ...
                <div class="text-center">
                    <h4 class="h5 mb-2"><a href="#" class="text-secondary">AirPods Pro 2Gen</a></h4>
                    ...
                    <h5 class="mb-0 text-primary">$5800.99</h5>
                </div>
            </div>
            <div class="col-sm-6 col-lg-3 mb-2-6">
                <div class="card-wrapper mb-4">
